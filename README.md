...
- 📈 Improved data ingestion efficiency by **40%** through automated data-processing modules
- 🌱 Currently deepening my skills in **distributed systems, ML pipelines, and cloud architecture**
- 📫 Reach me at **mwajeeh.urrehman@gmail.com**
...
**Backend Engineer Intern** — *Lumovy Technology Solutions* `Jul 2026 – Sep 2026`
- Building POS and School Management Systems with **.NET Framework, C#, and RESTful Web APIs**
- Designing low-latency backend API endpoints between services and databases
- Collaborating in agile sprints and writing unit tests to ensure software quality

**Software Engineer Intern** — *Brilliant Gamez* `Feb 2026 – Apr 2026`
- Engineered scalable software and automated data-processing modules (**+40% ingestion efficiency**)
- Optimized throughput via profiling, resource management, and multi-threaded processing
- Built modular backend components with **asynchronous programming** and real-time data streams
...
<p align="left">
  <a href="mailto:mwajeeh.urrehman@gmail.com">
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=YOUR_GITHUB_USERNAME&label=Profile%20Views&color=6f42c1&style=flat" alt="profile views" />
</p>
